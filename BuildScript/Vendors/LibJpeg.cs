...
{
    public class LibJpeg : ThirdParty
    {
        public LibJpeg(ProjectFile project, PlatformType platform, Configuration configuration)
            : base(project, platform, configuration)
        {

            project.IncludePath("%(VendorsDir)Scaleform/3rdParty/jpeg-8d/");
